...
import logging, sqlite3, asyncio, os, math
...
DB_PATH     = os.path.join(DATA_DIR, "assistenza.db")
WEB_DB_PATH = os.path.join(DATA_DIR, "web_assistenza.db")

BOT_TOKEN        = os.environ.get("BOT_TOKEN", "")
TECNICI_GROUP_ID = int(os.environ.get("TECNICI_GROUP_ID", "0"))
BACKOFFICE_IDS   = [int(x) for x in os.environ.get("BACKOFFICE_IDS", "0").split(",")]
...
TESTI = {
    "it": {
        "condizioni": (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "_Il pagamento va effettuato direttamente al tecnico al termine del servizio._\n\n"
            "👨‍🔧 *I NOSTRI TECNICI*\n"
    ...
    "en": {
        "condizioni": (
            ...
            "Rotondi Group technical assistance is a *paid service*, even when the intervention concerns a product *under warranty*.\n\n"
            "✅ *What we cover under warranty:*\n› *Defective spare parts* are replaced at no cost\n\n"
            "💶 *What is always charged to the customer:*\n› Labour\n› Technician travel\n› Call-out fee\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "📍 *ROME AREA RATES* _(Inside the GRA ring road)_\n"
            ...
            "👨‍🔧 *OUR TECHNICIANS*\n"
            "Our technicians are *independent freelance professionals*, selected by Rotondi Group. They are not company employees.\n\n"
    ...
    "bn": {
        "condizioni": (
            ...
            "✅ *ওয়ারেন্টিতে যা কভার:* › বিনামূল্যে খুচরা যন্ত্রাংশ প্রতিস্থাপন\n\n"
            "💶 *গ্রাহককে যা দিতে হবে:* › শ্রম খরচ › যাতায়াত › কল-আউট ফি\n\n"
            "📍 *রোমা:* আসা + ১ ঘণ্টা: *€ 80,00 + VAT*\n"
            "🗺 *বাইরে:* € 0,70/কিমি + € 32,00/ঘণ্টা + € 40,00/ঘণ্টা কাজ\n\n"
            "আপনি কি এই শর্তগুলি গ্রহণ করেন?"
        ),
        ...
        "assegnata": "🎯 *টেকনিশিয়ান নিয়োগ!*\n\n👨‍🔧  *{tecnico}*\n⏰  *{fascia}*\n\n⚠️ বাতিল: 📞 *+39 06 41 40 0514*\n\n_রোটোন্ডি গ্রুপ রোমা_",
        "proposta": "📅 *প্রস্তাব*\n\n*{tecnico}*: 🗓  *{data_ora}*\n\nগ্রহণ করবেন?",
        "proposta_accettata": "🎉 *নিশ্চিত!*\n\n👨‍🔧  *{tecnico}*\n🗓  *{data_ora}*\n\n_রোটোন্ডি গ্রুপ রোমা_",
        "proposta_rifiutata": "❌ *প্রত্যাখ্যাত*\n\n_রোটোন্ডি গ্রুপ রোমা_",
        "riassegnazione": "ℹ️ *আপডেট*\n\nঅনুরোধ পুনরায় খোলা হয়েছে।\n\n_রোটোন্ডি গ্রুপ রোমা_",
        "annulla": "❌ বাতিল।\n\n/start লিখুন।",
    },
    "zh": {
        "condizioni": (
            "━━━━━━━━━━━━━━━━━━━━━━\n🔧  *ROTONDI GROUP SRL*\n     罗马分公司\n━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "⚠️ *服务说明*\n\n罗通迪集团技术援助是*付费服务*，即使产品*在保修期内*。\n\n"
            "✅ *保修:* › 有缺陷备件免费更换\n\n💶 *客户承担:* › 人工费 › 差旅费 › 上门费\n\n"
            "📍 *罗马市区:* 上门+1小时: *€ 80,00 + 增值税*\n"
            "🗺 *其他地区:* € 0,70/公里 + € 32,00/小时路途 + € 40,00/小时工作\n\n"
            "您接受这些条件吗？"
        ),
        "condizioni_no": "❌ *未接受*\n\n写 /start 重新开始。\n\n_罗通迪集团罗马_",
        "nome":           "👤 *您的姓名？*\n_请写全名_",
        ...
        "assegnata": "🎯 *已分配技术人员！*\n\n👨‍🔧  *{tecnico}*\n⏰  *{fascia}*\n\n⚠️ 取消: 📞 *+39 06 41 40 0514*\n\n_罗通迪集团罗马_",
        "proposta": "📅 *预约提议*\n\n*{tecnico}*: 🗓  *{data_ora}*\n\n接受吗？",
        "proposta_accettata": "🎉 *已确认！*\n\n👨‍🔧  *{tecnico}*\n🗓  *{data_ora}*\n\n_罗通迪集团罗马_",
        "proposta_rifiutata": "❌ *已拒绝*\n\n_罗通迪集团罗马_",
        "riassegnazione": "ℹ️ *更新*\n\n请求已重新开放。\n\n_罗通迪集团罗马_",
        "annulla": "❌ 已取消。\n\n写 /start 重新开始。",
    },
    "ar": {
        "condizioni": (
            "━━━━━━━━━━━━━━━━━━━━━━\n🔧  *ROTONDI GROUP SRL*\n     فرع روما\n━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "⚠️ *معلومات الخدمة*\n\nالمساعدة الفنية خدمة *مدفوعة* حتى في الضمان.\n\n"
            "✅ *الضمان:* › استبدال القطع المعيبة مجاناً\n\n💶 *يتحمله العميل:* › أجرة العمل › التنقل › رسوم الزيارة\n\n"
            "📍 *روما:* زيارة+ساعة: *€ 80,00 + ضريبة*\n"
            "🗺 *خارج روما:* € 0,70/كم + € 32,00/ساعة سفر + € 40,00/ساعة عمل\n\n"
            "هل تقبل هذه الشروط؟"
        ),
        "condizioni_no": "❌ *لم تُقبل*\n\nاكتب /start للعودة.\n\n_روتوندي جروب روما_",
        "nome":           "👤 *ما اسمك؟*\n_اكتب الاسم الكامل_",
        "indirizzo":      "📍 *العنوان*\n\n_الشارع والرقم والمدينة_",
        "telefono":       "📞 *رقم الهاتف*",
        "foto_targhetta": "📸 *صورة اللوحة*\n\nإذا تعذر اكتب *تخطي*",
        "marca":          "🏭 *الماركة*",
        "modello":        "🔖 *الموديل*",
        ...
        "riepilogo": "📋 *الملخص*\n\n👤  {nome}\n📍  {indirizzo}\n📞  {telefono}\n\n🏭  *{marca}*  ·  {modello}\n🔢  {seriale}\n\n🔧  _{problema}_\n\nهل كل شيء صحيح؟",
        "si": "✅  تأكيد", "no": "✏️  تصحيح",
        "registrata": "✅ *تم الاستلام!*\n\n⚠️ للإلغاء: 📞 *+39 06 41 40 0514*\n\n_فريق روتوندي جروب روما_",
        "assegnata": "🎯 *تم التعيين!*\n\n👨‍🔧  *{tecnico}*\n⏰  *{fascia}*\n\n⚠️ للإلغاء: 📞 *+39 06 41 40 0514*\n\n_فريق روتوندي جروب روما_",
        "proposta": "📅 *اقتراح موعد*\n\n*{tecnico}*: 🗓  *{data_ora}*\n\nتقبل؟",
        "proposta_accettata": "🎉 *تم التأكيد!*\n\n👨‍🔧  *{tecnico}*\n🗓  *{data_ora}*\n\n_فريق روتوندي جروب روما_",
        "proposta_rifiutata": "❌ *مرفوض*\n\n_فريق روتوندي جروب روما_",
        "riassegnazione": "ℹ️ *تحديث*\n\nتم إعادة فتح طلبك.\n\n_فريق روتوندي جروب روما_",
        "annulla": "❌ تم الإلغاء.\n\nاكتب /start للبدء.",
    },
}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in BACKOFFICE_IDS:
        await update.message.reply_text(
            ...
            "/assegnate — chiamate già assegnate\n"
...
def calcola_preventivo_bot(indirizzo_cliente):
    try:
        ...
        params = {
            "origins": SEDE,
            "destinations": indirizzo_cliente + ", Italia",
            "mode": "driving",
            "key": GMAPS_KEY,
            "language": "it"
        }
        r = req_http.get("https://maps.googleapis.com/maps/api/distancematrix/json", params=params, timeout=10)
        data = r.json()
        ...
        if dist_km < 10:
            costo = 80.0
            zona = "inside_gra"
            dettaglio_it = f"Uscita + 1h lavoro: *€ 80,00 + IVA*"
        else:
            dist_ar  = dist_km * 2
            dur_ar   = math.ceil(dur_h * 2)
            costo_km = dist_ar * 0.70
            costo_v  = dur_ar * 32.0
            costo_l  = 40.0
            costo    = costo_km + costo_v + costo_l
            zona = "outside_gra"
            dettaglio_it = (
                f"Km A/R ({dist_ar:.0f}km × €0,70): *€{costo_km:.2f}*\n"
                f"Viaggio A/R ({dur_ar}h × €32,00): *€{costo_v:.2f}*\n"
                f"1h lavoro: *€{costo_l:.2f}*"
            )
        return {
            "zona": zona, "dist_km": round(dist_km, 1), "dur_h": round(dur_h, 1),
            "costo_min": round(costo, 2), "dettaglio_it": dettaglio_it,
            "dest_label": element["distance"]["text"], "dur_label": element["duration"]["text"]
        }
    except Exception as e:
...
async def raccogli_indirizzo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    context.user_data["indirizzo"] = traduci(indirizzo, lingua)
    prev = calcola_preventivo_bot(indirizzo)
    if prev:
        context.user_data["preventivo"] = prev
        PREV_TESTI = {
            "it": f"💰 *PREVENTIVO INDICATIVO*\n{'─'*24}\n📍 *Zona:* {'Zona di Roma (dentro GRA)' if prev['zona']=='inside_gra' else 'Provincia di Roma, Lazio e resto d Italia'}\n🗺 *Distanza:* {prev['dest_label']} — {prev['dur_label']}\n\n{prev['dettaglio_it']}\n\n💶 *Costo minimo stimato:* €{prev['costo_min']:.2f} + IVA\n{'─'*24}\n_Preventivo indicativo per 1h di lavoro._",
            "en": f"💰 *INDICATIVE QUOTE*\n{'─'*24}\n📍 *Zone:* {'Rome area (inside GRA)' if prev['zona']=='inside_gra' else 'Rome province and rest of Italy'}\n🗺 *Distance:* {prev['dest_label']} — {prev['dur_label']}\n\n{prev['dettaglio_it']}\n\n💶 *Estimated minimum cost:* €{prev['costo_min']:.2f} + VAT",
            "bn": f"💰 *আনুমানিক খরচ*\n📍 {prev['dest_label']} — {prev['dur_label']}\n\n{prev['dettaglio_it']}\n\n💶 *সর্বনিম্ন:* €{prev['costo_min']:.2f} + IVA",
            "zh": f"💰 *预估报价*\n📍 {prev['dest_label']} — {prev['dur_label']}\n\n{prev['dettaglio_it']}\n\n💶 *最低费用:* €{prev['costo_min']:.2f} + 增值税",
            "ar": f"💰 *عرض سعر تقريبي*\n📍 {prev['dest_label']} — {prev['dur_label']}\n\n{prev['dettaglio_it']}\n\n💶 *الحد الأدنى:* €{prev['costo_min']:.2f} + ضريبة",
        }
        await update.message.reply_text(PREV_TESTI.get(lingua, PREV_TESTI["it"]), parse_mode="Markdown")
...
async def conferma(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    prev_text = ""
    if prev:
        prev_text = f"\n💰 *Preventivo:* €{prev['costo_min']:.2f} + IVA ({prev['dest_label']} — {prev['dur_label']})"
    testo_gruppo = (
    ...
    for foto, cap in [
        ...
        if foto:
            try:
                await context.bot.send_photo(chat_id=TECNICI_GROUP_ID, photo=foto, caption=cap)
            except Exception as e:
                log.error(f"Foto: {e}")
...
<div style="background:#fff;padding:24px;border-radius:0 0 8px 8px">
  <h2 style="color:#1a1a2e">👨‍🔧 Tecnico assegnato!</h2>
  <p>Gentile <b>{nome_cliente}</b>, un tecnico è stato assegnato alla sua richiesta.</p>
  <div style="background:#f5f5f5;border-radius:8px;padding:16px;margin:16px 0">
    ...
    <p style="margin:0;font-size:15px"><b>Orario:</b> {fascia_it}</p>
  </div>
  <p style="color:#555;font-size:14px">Ufficio: <b>+39 06 41400617</b></p>
  <p style="color:#888;font-size:13px">Per annullare: <b>+39 06 41 40 0514</b></p>
</div></div>"""
    if email_cliente and SMTP_USER_W and SMTP_PASS_W:
        ...
        try:
            ...
            msg["Subject"] = SOGGETTI.get(lingua, SOGGETTI["it"])
...
async def gestisci_programma(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(
        f"🗓 *Da programmare — Chiamata #{cid}*\n\n👤 *Cliente:* {ch[4]}\nScegli la *data* dell'intervento:",
...
async def gestisci_ora(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(
        ...
        f"👤 *Cliente:* {ch[4]}\n📍 *Indirizzo:* {ch[5]}\n🔧 *Problema:* {ch[7]}\n{'─'*30}\n"
        f"👨‍🔧 *Tecnico:* {nome_finale}\n📅 *Proposta:* {data_ora}\n\n_In attesa che il cliente accetti..._",
        parse_mode="Markdown"
    )
    lingua_cliente = ch[3]
    ...
    try:
        await context.bot.send_message(
            ...
            reply_markup=keyboard_cliente, parse_mode="Markdown"
        )
    except Exception as e:
...
async def gestisci_conferma_proposta(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if risposta == "si":
        ...
        reset_proposta(cid)
        await query.edit_message_text(t(lingua_cliente, "proposta_rifiutata"), parse_mode="Markdown")
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🕛 Entro le 12:00", callback_data=f"fascia_{cid}_entro12"),
             InlineKeyboardButton("🕕 Entro le 18:00", callback_data=f"fascia_{cid}_entro18")],
            [InlineKeyboardButton("📅 In giornata",    callback_data=f"fascia_{cid}_giornata"),
...
async def lista(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for r in rows:
        ...
        testo += f"🕐 {r[6]}"
        if r[3] in ("assegnata", "in_attesa_conferma"):
            kb = InlineKeyboardMarkup([[InlineKeyboardButton("🔓 Sblocca e rimetti in circolo", callback_data=f"sblocca_{r[0]}")]])
...
async def gestisci_sblocco(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        await context.bot.send_message(
            chat_id=TECNICI_GROUP_ID,
            text=(f"🔔 *CHIAMATA #{cid} — RIASSEGNAZIONE* {flag}\n{'─'*28}\n"
                  f"👤 *Cliente:* {ch[4]}\n📍 *Indirizzo:* {ch[5]}\n"
                  f"🗺 [Apri su Google Maps]({link_maps})\n📞 *Telefono:* {ch[6]}\n🔧 *Problema:* {ch[7]}\n{'─'*28}\n"
                  f"⚠️ _Chiamata rimessa in circolo dal back office_\n⏰ Primo tecnico disponibile: clicca:"),
            reply_markup=keyboard, parse_mode="Markdown"
        )
    except Exception as e:
    ...
    if tecnico_precedente_id:
        try:
            await context.bot.send_message(
                ...
                text=f"ℹ️ *Chiamata #{cid} rimessa in circolo*\n\nLa chiamata del cliente *{ch[4]}* è stata rimessa nel circuito dal back office.\n\n_Rotondi Group Roma_",
                parse_mode="Markdown"
            )
        except Exception as e:
...
async def _invia_storico(msg, context, mese, anno):
    with sqlite3.connect(DB_PATH) as conn:
        if mese == 0:
            rows = conn.execute("""
                ...
                FROM chiamate WHERE data_apertura LIKE ? ORDER BY id DESC
            """, (f"%/{anno}%",)).fetchall()
            periodo = f"Anno {anno}"
        else:
            rows = conn.execute("""
    ...
    tecnici_count = {}
    for r in rows:
        if r[4]: tecnici_count[r[4]] = tecnici_count.get(r[4], 0) + 1
    riepilogo = (
    ...
    for i in range(0, len(rows), BLOCCO):
        ...
        for r in blocco:
            ...
            if r[4]:
                ...
                testo += "\n"
            if r[8] or r[9]: testo += f"🏭 {r[8] or '—'} · {r[9] or '—'}\n"
...
async def statistiche(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        tecnici_rows = conn.execute("""
            ...
            FROM chiamate WHERE tecnico_nome IS NOT NULL AND tecnico_nome != ''
            GROUP BY tecnico_nome ORDER BY totale DESC
        """).fetchall()
        tecnici_mese = conn.execute("""
            SELECT tecnico_nome, COUNT(*) as totale FROM chiamate
            WHERE tecnico_nome IS NOT NULL AND tecnico_nome != '' AND data_apertura LIKE ?
            GROUP BY tecnico_nome ORDER BY totale DESC
        """, (f"%/{mese_corrente}%",)).fetchall()
        lingue_rows = conn.execute("""
            SELECT lingua, COUNT(*) as tot FROM chiamate GROUP BY lingua ORDER BY tot DESC
        """).fetchall()
...
def main():
    ...
    application.add_handler(conv_registrami)
    application.add_handler(CallbackQueryHandler(gestisci_fascia,            pattern=r"^fascia_"))
    application.add_handler(CallbackQueryHandler(gestisci_wfascia,           pattern=r"^wfascia_"))
    application.add_handler(CallbackQueryHandler(gestisci_programma,         pattern=r"^programma_"))
    application.add_handler(CallbackQueryHandler(gestisci_data,              pattern=r"^pdata_"))
    application.add_handler(CallbackQueryHandler(gestisci_ora,               pattern=r"^pora_"))
    application.add_handler(CallbackQueryHandler(gestisci_conferma_proposta, pattern=r"^cprop_"))
    application.add_handler(CommandHandler("lista",       lista))
    application.add_handler(CommandHandler("aperte",      aperte))
    application.add_handler(CommandHandler("assegnate",   assegnate))
    application.add_handler(CommandHandler("chiamate",    mie_chiamate))
    ...
    application.add_handler(CallbackQueryHandler(gestisci_storico, pattern=r"^storico_"))
    application.add_handler(CallbackQueryHandler(gestisci_sblocco, pattern=r"^sblocca_"))
    log.info("🤖 Bot avviato!")
    t = Thread(target=avvia_http, daemon=True)
    t.start()
    log.info("🌐 Health server avviato")
